...
export const projects = [
  ...
  },
  {
    ...
    title: "Tounes.AI",
    description:
      "AI-powered cultural storytelling platform that transforms Tunisian landmarks into immersive, personalized narrative experiences with computer vision, LLMs, and multilingual speech synthesis.",
    tech: ["Python", "Streamlit", "Groq", "LLM", "Vision AI", "Edge TTS"],
    features: [
      "Vision AI landmark identification",
    ...
    github: "https://github.com/MohamedZouari4/Tounes.AI",
  },
];
